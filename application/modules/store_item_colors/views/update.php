<ul class="breadcrumb">
    ...
    <li>
        <i class="icon-edit"></i>
        <a href="<?php echo base_url("store_items/create/$update_id"); ?>">Item</a>
        <i class="icon-angle-right"></i>
    </li>
    <li>
        <i class="icon-edit"></i>
...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            ...
            <form class="form-horizontal" action="<?php echo base_url('store_item_colors/submit/' . $update_id); ?>" method="post">
                <fieldset>
...
<div class="row-fluid sortable">
    <div class="box span12">
    	<div class="box-header" data-original-title>
    		<h2><i class="halflings-icon white edit"></i><span class="break"></span>Color Options</h2>
    		<div class="box-icon">
    			<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
    		</div>
    	</div>
    	<div class="box-content">
    		<table class="table table-striped table-bordered bootstrap-datatable datatable">
    			...
    			<tr>
    				...
    				<td class="center">
    					<a class="btn btn-danger" href="<?php echo base_url("store_item_colors/delete/$row->id"); ?>">
